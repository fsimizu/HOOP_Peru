            ...
            <div className="container">
                <div className="d-flex justify-content-end h-100">
                        <div className="text-right text-white col-lg-4 col-md-8">
                            ...
                            <h4 className="mb-3 text-main text-right"><strong>An NGO working with vulnerable communities in the <span className="hero__yellow-text">cono norte of Arequipa Peru.</span></strong></h4>
                        </div>
                </div>
            </div>
